...
Kubernetes is very extensible, as the abundance of https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/#custom-resources[Custom Resource Definitions] illustrates.  Deployment definitions should be able include all of them easily without requiring new code.
